...
if(isset($_POST['create'])){
    ...
    $sql = mysqli_query($koneksi,"INSERT INTO pengembalian VALUES(null,'$kembali','$denda','$buku','$user','$admin')");
        if ($sql) {
...
<h2>Buat Data Pengembalian</h2>
    ...
    <div class="col">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="tgl_pengembalian" id="tgl_pengembalian" required>
        </div>
        <div class="mb-3">
